...
function GitHubIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 2C6.48 2 2 6.58 2 12.24c0 4.52 2.87 8.35 6.84 9.7.5.1.68-.22.68-.49 0-.24-.01-1.04-.01-1.9-2.78.62-3.37-1.22-3.37-1.22-.46-1.18-1.11-1.5-1.11-1.5-.91-.64.07-.63.07-.63 1 .07 1.53 1.06 1.53 1.06.9 1.57 2.35 1.12 2.92.86.09-.67.35-1.12.64-1.38-2.22-.26-4.56-1.14-4.56-5.06 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.3.1-2.71 0 0 .84-.28 2.75 1.05A9.2 9.2 0 0 1 12 6.9c.85 0 1.7.12 2.5.36 1.91-1.33 2.75-1.05 2.75-1.05.55 1.41.2 2.45.1 2.71.64.72 1.03 1.63 1.03 2.75 0 3.93-2.34 4.8-4.57 5.05.36.32.68.94.68 1.9 0 1.37-.01 2.47-.01 2.81 0 .27.18.59.69.49A10.25 10.25 0 0 0 22 12.24C22 6.58 17.52 2 12 2Z" />
    </svg>
  )
}
...
function ProjectsWindow({ onClose }) {
  const projects = [
    
    {
      ...
      description:
        "A responsive healthcare website showcasing home care services, service information, and contact options through a modern, user-friendly interface.",
    ...
    },
    {
      name: "Book Nest",
      description:
        "A responsive online bookstore website for browsing books, exploring categories, and viewing book details through a clean, user-friendly interface.",
      type: "Web Development",
      technologies: ["HTML", "CSS", "JavaScript"],
      github:
